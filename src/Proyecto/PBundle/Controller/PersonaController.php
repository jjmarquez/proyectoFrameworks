...
use Proyecto\PBundle\Entity\Persona;
use Proyecto\PBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProyectoPBundle:Persona')->findAll();

        return $this->render('ProyectoPBundle:Persona:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ProyectoPBundle:Persona:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProyectoPBundle:Persona')->find($id);
        ...
        return $this->render('ProyectoPBundle:Persona:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProyectoPBundle:Persona:edit.html.twig', array(
            'entity'      => $entity,
